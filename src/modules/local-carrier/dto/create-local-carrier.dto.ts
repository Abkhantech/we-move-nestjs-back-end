...
export class CreateLocalCarrierDto {
  @ApiProperty({
  ...
  @ApiProperty({
    description: "States Zip Code  of the Local-Carrier",
    example: [
      {
        pickup_service_state: "New York",
        zip_codes: [
          {
            zip_code: "33333",
          },
        ...
        point_of_contact_name: "ABC",
        point_of_contact_phone_number: "+11234567890"
      },
      {
        pickup_service_state: "San Francisco",
        zip_codes: [
          {
            zip_code: "44444",
          },
